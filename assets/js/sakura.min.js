...
function _iterableToArrayLimit(t, e) {
  ...
  if (null != r) {
    ...
    try {
      for (
        r = r.call(t);
        !(i = (n = r.next()).done) && (o.push(n.value), !e || o.length !== e);
        i = !0
      );
    } catch (t) {
      (l = !0), (a = t);
...
function _createForOfIteratorHelper(t, e) {
  var r,
    n = ("undefined" != typeof Symbol && t[Symbol.iterator]) || t["@@iterator"];
  if (!n) {
    if (
      Array.isArray(t) ||
...
var Sakura = function (t, e) {
  ...
  (this.settings =
    ...
    Object.keys(r).forEach(function (t) {
      n && Object.prototype.hasOwnProperty.call(n, t) && (r[t] = n[t]);
    }),
    r)),
    (this.petalsWeak = new Map()),
    setInterval(function () {
      if (u.settings.lifeTime) {
        var t,
          e = [],
          r = Date.now(),
          n = _createForOfIteratorHelper(u.petalsWeak);
        try {
          for (n.s(); !(t = n.n()).done; ) {
            var a = _slicedToArray(t.value, 2),
              o = a[0],
              i = a[1];
            o + u.settings.lifeTime < r && (e.push(o), i.remove());
          }
        } catch (t) {
          n.e(t);
        } finally {
  ...
  function s(t, e, r) {
    for (var n = 0; n < l.length; n += 1) {
      var a = e;
      l[n] || (a = e.toLowerCase()), t.addEventListener(l[n] + a, r, !1);
    }
  }
  function c(t) {
  ...
  (this.createPetal = function () {
    u.el.dataset.sakuraAnimId &&
      setTimeout(function () {
        window.requestAnimationFrame(u.createPetal);
      }, u.settings.delay);
    var t = [
        "sway-0",
        "sway-1",
      ...
      r =
        ...
        u.settings.fallSpeed,
      e = [
        "fall ".concat(r, "s linear 0s 1"),
        ""
          .concat(e, " ")
          .concat((30 < r ? r : 30) - 20 + i(0, 20), "s linear 0s infinite"),
        "".concat(t, " ").concat(i(2, 4), "s linear 0s infinite"),
      ].join(", "),
      n = document.createElement("div"),
      r =
        (n.classList.add(u.settings.className),
        i(u.settings.minSize, u.settings.maxSize)),
      t = r - Math.floor(i(0, u.settings.minSize) / 3),
      a = o(u.settings.colors);
    (n.style.background = "linear-gradient("
      .concat(a.gradientColorDegree, "deg, ")
      .concat(a.gradientColorStart, ", ")
      .concat(a.gradientColorEnd, ")")),
      (n.style.webkitAnimation = e),
      (n.style.animation = e),
      (n.style.borderRadius = ""
        .concat(
          i(
            u.settings.maxSize,
            u.settings.maxSize + Math.floor(10 * Math.random())
          ),
          "px "
        )
        .concat(i(1, Math.floor(t / 4)), "px")),
      ...
      s(n, "AnimationEnd", function () {
        c(n) || n.remove();
      }),
      s(n, "AnimationIteration", function () {
        c(n) || n.remove();
      }),
      u.petalsWeak.set(Date.now(), n),
      u.el.appendChild(n);
  }),
...
(Sakura.prototype.start = function () {
  ...
  (Sakura.prototype.stop = function () {
    var e = this,
      ...
      r = this.el.dataset.sakuraAnimId;
    r &&
